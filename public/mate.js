export default function MateSVG (
	{
	...
	return (
		<svg 
			...
			x="0px"
			y="0px"
			viewBox="0 0 468.3 133.2"
		>
		<g>
			<g>
				<g fill={st0}>
					<path fill={title} d="M193.3,39.7H213v6.9c5.4-5.2,11.4-7.7,18.1-7.7c8.3,0,14.6,3.5,19,10.5c4.4-7.1,10.8-10.6,19-10.6
				...
				<g fill={st0}>
					<path fill={title} d="M338.2,39.7H358v56h-19.9v-6.2c-4.2,5.3-9.9,8-17.1,8c-4.1,0-7.8-0.7-11.2-2.2c-3.4-1.5-6.4-3.6-8.9-6.3
				...
				<g fill={st0}>
					<path fill={title} d="M391.2,56.2v39.5h-19.7V56.2h-6.5V39.7h6.5V22.9h19.7v16.8h11.2v16.5H391.2z"/>
				</g>
				<g fill={st0}>
					<path fill={title} d="M424.4,71c0,8.5,4,12.8,12,12.8c4.3,0,7.5-1.7,9.7-5.2h19.1c-3.9,12.8-13.5,19.2-28.9,19.2
				...
				<g>
					<path fill={leftLogo} d="M62.1,35.3l11.7,8.2L62.2,60.1l-11.6-8.2c-2.7-1.9-6.1-3.1-9.4-3.4c-10.5-0.9-19.9,7-20.8,17.5
					...
					<path fill={rightLogo} d="M138.7,107c21.6,1.8,40.9-14.4,42.7-36c1.8-21.6-14.4-40.9-36-42.7c-13.9-1.2-27.8,5.3-35.7,16.8L87.1,77.4
